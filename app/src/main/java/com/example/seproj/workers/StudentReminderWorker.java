...
/**
 * One-time worker for sending a student reminder notification.
 */
public class StudentReminderWorker extends Worker {

    public StudentReminderWorker(@NonNull Context context,
    ...
    public Result doWork() {
        ...
        String studentId = getInputData().getString(ReminderSchedulerService.KEY_STUDENT_ID);
        long appointmentStartMillis =
                getInputData().getLong(ReminderSchedulerService.KEY_APPOINTMENT_START, -1L);

        if (slotId == null || studentId == null || appointmentStartMillis <= 0) {
        ...
        try {
            ...
            Boolean alreadySent = slotSnapshot.getBoolean("reminder24hSentStudent");
            ...
            AppNotification notification = new AppNotification(
                    ...
                    "Reminder: your appointment is in about 24 hours at " + formattedTime + ".",
                    slotId,
            ...
            Tasks.await(
                    db.collection("appointment_slots")
                            .document(slotId)
                            .update("reminder24hSentStudent", true)
            );
